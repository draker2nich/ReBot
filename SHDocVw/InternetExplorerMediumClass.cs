...
// Type: SHDocVw.InternetExplorerMediumClass
...
namespace SHDocVw
{
  ...
  [ComImport]
  public class InternetExplorerMediumClass : 
    IWebBrowser2,
    ...
    DWebBrowserEvents_Event
  {
    ...
    public extern InternetExplorerMediumClass();
    ...
    [DispId(-525)]
    public virtual extern tagREADYSTATE ReadyState { [DispId(-525), TypeLibFunc(4), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
